...
| # | 切片 | 类型 | 依赖 | 状态 |
|---|------|------|------|------|
| p1-001 | [安全修复 — API key 轮换 + git 历史清理 + env 校验](P1/p1-001-security-fix.md) | AFK | — | ⏳ 待开始 |
| p1-002 | [CORS 中间件 + CI/CD](P1/p1-002-cors-ci.md) | AFK | — | ⏳ 待开始 |
...
| # | 切片 | 类型 | 依赖 | 状态 |
|---|------|------|------|------|
| p1-003 | [规则引擎 v2 — 从评分者到特征提取器](P1/p1-003-engine-v2-features.md) | AFK | — | ⏳ 待开始 |
| p1-004 | [Prompt v2 — 6 锚点评分 + 特征注入 + 软化分布](P1/p1-004-prompt-v2-anchors.md) | AFK | p1-003 | ⏳ 待开始 |
| p1-005 | [校准 CLI + Prompt v2 验证（P1 Gate）](P1/p1-005-calibration-cli-gate.md) | AFK | p1-004 | ⏳ 待开始 |
...
| P1.3 | p1-014, p1-015, p1-016, p1-017 | 评估结果入库 + 历史仪表盘 + 报告分享 | 数据持久化，依赖引擎架构稳定 |
| P1.4 | p1-018, p1-019, p1-020, p1-021 | pgvector 向量记忆上线 | 长篇小说记忆管理，依赖持久化 |
| P1.5 | p1-022, p1-023, p1-024 | 文风/AI检测/题材热度 | 扩展评估维度 |
| P1.6 | p1-025, p1-026 | 微信/支付宝支付 + 三级会员 | 商业化，依赖用户系统 |
